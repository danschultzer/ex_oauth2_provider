defmodule ExOauth2Provider.Utils.Error do
  ...
  @doc false
  @spec add_error(Map.t, {:error, Map.t, atom}) :: Map.t
  ...
  @spec server_error() :: {:error, Map.t, atom}
  def server_error do
  ...
  @doc false
  @spec invalid_request() :: {:error, Map.t, atom}
  ...
  @doc false
  @spec invalid_client() :: {:error, Map.t, atom}
  ...
  @doc false
  @spec invalid_grant() :: {:error, Map.t, atom}
  ...
  @doc false
  @spec unsupported_grant_type() :: {:error, Map.t, atom}
  ...
  @doc false
  @spec invalid_scopes() :: {:error, Map.t, atom}
  ...
  @doc false
  @spec invalid_redirect_uri() :: {:error, Map.t, atom}
  ...
  @doc false
  @spec access_denied() :: {:error, Map.t, atom}
  ...
  @doc false
  @spec unsupported_response_type() :: {:error, Map.t, atom}
